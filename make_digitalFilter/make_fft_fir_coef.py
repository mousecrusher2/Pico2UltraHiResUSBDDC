...
def main():
    ...
    with header_path.open("w", encoding="utf-8") as hf:
        ...
        hf.write(
            f"static constexpr uint16_t CORE1_POLY_TAPS_MAX = {maxima['poly_taps']};\n"
        )
        hf.write(
            "static constexpr uint16_t CORE1_POLY_PHASE_LEN_MAX = "
            f"{maxima['poly_phase_len']};\n\n"
        )
        hf.write(
